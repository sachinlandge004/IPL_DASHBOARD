...
public class BatchConfig {
    ...
    public FlatFileItemReader<MatchInput> reader(){
        return new FlatFileItemReaderBuilder<MatchInput>().name("MatchItemReade")
    ...
    //Processes the MatchInput and Convert it into Match type
    @Bean
    ...
    //Batch Job which takes One Step at a time
    @Bean
